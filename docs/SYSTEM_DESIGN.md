...
为满足不同读者的需求，本项目提供多份文档：

| 文档 | 目标读者 | 内容 |
|------|----------|------|
| `AGENTS.md` | LLM（大语言模型） | 快速理解系统的协作指南，包含修改规则和最佳实践 |
| `README.md` | 中文开发者 | 中文使用文档，包含快速开始和 API 参考 |
| `README_EN.md` | 英文开发者 | 英文使用文档，与中文文档内容同步 |
| `docs/SYSTEM_DESIGN.md` | 架构师/高级开发者 | 本文档，完整的系统设计文档 |

**⚠️ 重要规则：**

每次代码变更后，必须更新 `docs/SYSTEM_DESIGN.md`！具体包括：
- 新增的类/方法说明
- 修改的架构图
- 新增的事件类型
- 变更的依赖关系
